...
<template>
  <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
    ...
    <el-form-item>
      <el-button type="primary" @click="submitForm('ruleForm')">确认修改司机信息</el-button>
...
<script>
  export default {
      ...
      submitForm(formName) {
        ...
        this.$refs[formName].validate((valid) => {
          ...
          if (valid) {
            ...
            axios.put('http://127.0.0.1:8081/customer/drivers/updateDriver',this.ruleForm).then(function (resp) {
    ...
    created() {
      const _this = this
      axios.get('http://127.0.0.1:8081/customer/drivers/findDriversById/'+this.$route.query.driverId).then(function (resp) {
